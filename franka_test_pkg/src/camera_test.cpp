...
int main(int argc, char** argv)
{
    ...
    robot.ptp_abs(make_pose_stamped(40_cm, 0_cm, 35_cm, 180_deg, 0_deg, 180_deg, "world"));
    robot.lin_abs(make_pose_stamped(40_cm, 0_cm, 35_cm, 180_deg, 0_deg, 180_deg, "world"), "panda_hand_cam", true);
    robot.ptp_abs(make_pose_stamped(40_cm, 0_cm, 35_cm, 180_deg, 0_deg, 180_deg, "world"));
    robot.ptp_abs(make_pose_stamped(40_cm, 0_cm, 35_cm, 180_deg, 0_deg, 180_deg, "world"), "panda_hand_cam", true);
